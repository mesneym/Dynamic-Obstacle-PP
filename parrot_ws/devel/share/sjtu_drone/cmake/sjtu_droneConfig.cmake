...
if("TRUE" STREQUAL "TRUE")
  set(sjtu_drone_SOURCE_PREFIX /home/ak/Dynamic-Obstacle-PP/parrot_ws/src/parrot_ardrone/sjtu_drone)
  set(sjtu_drone_DEVEL_PREFIX /home/ak/Dynamic-Obstacle-PP/parrot_ws/devel)
  ...
  set(sjtu_drone_INSTALL_PREFIX /home/ak/Dynamic-Obstacle-PP/parrot_ws/install)
...
if(NOT "/home/ak/Dynamic-Obstacle-PP/parrot_ws/src/parrot_ardrone/sjtu_drone/include " STREQUAL " ")
  set(sjtu_drone_INCLUDE_DIRS "")
  set(_include_dirs "/home/ak/Dynamic-Obstacle-PP/parrot_ws/src/parrot_ardrone/sjtu_drone/include")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'sjtu_drone' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/ak/Dynamic-Obstacle-PP/parrot_ws/src/parrot_ardrone/sjtu_drone/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/ak/Dynamic-Obstacle-PP/parrot_ws/devel/lib;/home/ak/drone_ws/devel/lib;/home/ak/teleop_ws/devel/lib;/opt/ros/kinetic/lib)
